...
SECRET_KEY = 'django-insecure-)9iv@%u64+uhedy7-0r*)4n#8jargx45$oycrq%zm)^y_t$c-('
...
STATICFILES_DIRS = [
    BASE_DIR / "static",   # jaha tum CSS rakhte ho
]

STATIC_ROOT = BASE_DIR / "staticfiles"  # production ke liye
